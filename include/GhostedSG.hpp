...
public:
     ...
     */
    GhostedSG(const std::array<size_t, 3> &nodes,
              const std::array<size_t, 2> &ghosts_x,
              const std::array<size_t, 2> &ghosts_y,
              const std::array<size_t, 2> &ghosts_z)
     ...
     */
    GhostedSG(const std::array<size_t, 3> &nodes, size_t ghosts)
            : GhostedSG(nodes,
...
#pragma inline
     ...
     */
    Real &operator()(Component c, size_t i, size_t j, size_t k) override;
...
#pragma inline
     ...
     */
    const Real &operator()(Component c, size_t i, size_t j, size_t k) const override;
