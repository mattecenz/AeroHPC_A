...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                        \
    U(Y2, i, j, k) = U(Y2star, i, j, k) - consts.inv_k_0 * mu::dp_dx_U(PHI_2_P_N, i, j, k);  \
    V(Y2, i, j, k) = V(Y2star, i, j, k) - consts.inv_k_0 * mu::dp_dy_V(PHI_2_P_N, i, j, k);  \
    W(Y2, i, j, k) = W(Y2star, i, j, k) - consts.inv_k_0 * mu::dp_dz_W(PHI_2_P_N, i, j, k);  \
ITERATE_DOMAIN_END()                                                                    \
...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                            \
    U(Y3, i, j, k) = U(Y3star, i, j, k) - consts.inv_k_3 * mu::dp_dx_U(PHI_3_PHI_2, i, j, k);    \
    V(Y3, i, j, k) = V(Y3star, i, j, k) - consts.inv_k_3 * mu::dp_dy_V(PHI_3_PHI_2, i, j, k);    \
    W(Y3, i, j, k) = W(Y3star, i, j, k) - consts.inv_k_3 * mu::dp_dz_W(PHI_3_PHI_2, i, j, k);    \
ITERATE_DOMAIN_END()                                                                        \
ITERATE_DOMAIN_PRESSURE(i, j, k, false)                                                     \
...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                                \
    U(U_N1, i, j, k) = U(U_N1star, i, j, k) - consts.inv_k_6 * mu::dp_dx_U(P_N1_PHI_3, i, j, k);     \
    V(U_N1, i, j, k) = V(U_N1star, i, j, k) - consts.inv_k_6 * mu::dp_dy_V(P_N1_PHI_3, i, j, k);     \
    W(U_N1, i, j, k) = W(U_N1star, i, j, k) - consts.inv_k_6 * mu::dp_dz_W(P_N1_PHI_3, i, j, k);     \
ITERATE_DOMAIN_END()                                                                            \
ITERATE_DOMAIN_PRESSURE(i, j, k, false)                                                         \
