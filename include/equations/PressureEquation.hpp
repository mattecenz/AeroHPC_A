...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                        \
    std::cout << "(" << i << " " << j << " " << k << ") = (" << mu::dp_dx_U(PHI_2_P_N, i, j, k) << ", " << mu::dp_dy_V(PHI_2_P_N, i, j, k) << ", " << mu::dp_dz_W(PHI_2_P_N, i, j, k) << ")"<< std::endl;   \
...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                            \
std::cout << "(" << i << " " << j << " " << k << ") = (" << mu::dp_dx_U(PHI_3_PHI_2, i, j, k) << ", " << mu::dp_dy_V(PHI_3_PHI_2, i, j, k) << ", " << mu::dp_dz_W(PHI_3_PHI_2, i, j, k) << ")"<< std::endl;   \
...
ITERATE_DOMAIN_VELOCITY(i, j, k, false, NO_SKIP)                                                \
std::cout << "(" << i << " " << j << " " << k << ") = (" << mu::dp_dx_U(P_N1_PHI_3, i, j, k) << ", " << mu::dp_dy_V(P_N1_PHI_3, i, j, k) << ", " << mu::dp_dz_W(P_N1_PHI_3, i, j, k) << ")"<< std::endl;   \
